    ...
    <LayoutHome windowTitle="Conditions générales d’Utilisation">
      <div className={`${styles.container} fr-container`}>
        <div className={styles.contentWrapper}>
          ...
          <p>
            La plateforme constitue le téléservice pour l’obtention des
            autorisations individuelles de travail pour les enfants de moins de
            16 ans travaillant dans des spectacles, telles que prévues aux
            articles L. 7124-1 et R. 7124-1 du code du travail. Elle a pour
            objectif de numériser les dossiers essentiels à la procédure
            relative aux autorisations individuelles de travail pour les enfants
            concernés, et de mettre en place un service numérique d’instruction
            des données.
          </p>
          ...
          <ul>
            ...
            <li>
              référencer les informations nécessaires sur les enfants, ainsi que
              les pièces justificatives, manuellement ou de manière automatisée
              via l’import d’un fichier modèle excel ;
            </li>
          ...
          <ul>
            ...
            <li>
              consulter les pièces justificatives nécessaires à la bonne
              réalisation d’un examen médical relatif à une prestation de
              spectacle, cinéma, théâtre, jeux vidéos, concert ;
            </li>
            <li>
