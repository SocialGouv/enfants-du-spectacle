  ...
  try {
    const dossierLoop = () => {
      for (const dossier of data.demarche.dossiers.nodes) {
        ...
        const societeProd = searchSocieteProductionBySiret(
          prisma,
        ...
        console.log(societeProd);
      }
    };
    console.log(dossierLoop);
  } catch (e: unknown) {
    return { error: e };
  }
