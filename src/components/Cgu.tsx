...
const Cgu: React.FC<Props> = ({ isModal, onCheckChange }) => {
  ...
  const handleCheckChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    localStorage.setItem("enfants-du-spectacle-cgu", "accepted");
  };
  ...
  return (
    <div className={`${styles.container} fr-container`}>
      ...
      <p>
        ...
        le cadre juridique de la plateforme Enfants du spectacle (ci-après « la
        plateforme ») et définissent les conditions d’accès et d’utilisation des
        services par les agents de la Direction régionale interdépartementale de
      ...
      <div className={styles.contentWrapper}>
        ...
        <ul>
          <li>
            ...
            individuelle de travail pour des mineurs de moins de 16 ans dans le
            cadre d’un spectacle vivant, d’un tournage ou d’un doublage, dans
            les conditions prévues aux articles L 7124-1 et R. 7124-1 du code du
            travail ;
          </li>
        ...
        <div>
          ...
          ambulantes, la publicité et la mode ; ainsi que les personnes agissant
          pour son compte, à savoir les assistantes médicales chargés de prendre
        ...
        <ul>
          ...
          <li>
            ...
            expliciter le refus d’une pièce justificative ou apporter tous types
            d’informations complémentaires (pièce illisible, format non
            compatible…) ;
          </li>
        ...
        <div>
          L’un des Instructeurs (l’administrateur des Instructeurs) bénéficie de
          fonctionnalités supplémentaires : il peut répartir les dossiers aux
          Instructeurs.
        </div>
        ...
        <div>
          ...
          un accès continu, sans contrepartie financière au site. Il se réserve
          la liberté de faire évoluer, de modifier ou de suspendre, sans
        ...
        <div>
          Les Instructeurs s’engagent à ne pas commercialiser les données reçues
          et à ne pas les communiquer à des tiers en dehors des cas prévus par
          la loi.
        </div>
        <div>
          Toute information transmise par lui est de sa seule responsabilité. Il
          est rappelé que toute personne procédant à une fausse déclaration pour
          elle-même ou pour autrui s’expose, notamment, aux sanctions prévues à
          l’article 441-1 du code pénal, prévoyant des peines pouvant aller
        ...
        {isModal && (
          <div className={styles.checkboxWrapper}>
            <Checkbox
              ...
              label={
                "En cochant cette case, je confirme avoir lu et accepté les conditions générales d'utilisation."
              }
              hint={`Vous devez accepter les conditions générales d'utilisation pour accéder à la plateforme.`}
