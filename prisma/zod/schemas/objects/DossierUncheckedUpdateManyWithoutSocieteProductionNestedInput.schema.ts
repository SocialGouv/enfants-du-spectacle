...
const Schema: z.ZodType<Prisma.DossierUncheckedUpdateManyWithoutSocieteProductionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DossierUncheckedUpdateManyWithoutSocieteProductionNestedInputObjectSchema =
  Schema;
