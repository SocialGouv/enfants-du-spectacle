...
const Schema: z.ZodType<Prisma.NestedEnumSourceNullableWithAggregatesFilter> = z
  .object({
    equals: z
      .lazy(() => SourceSchema)
      .optional()
...
export const NestedEnumSourceNullableWithAggregatesFilterObjectSchema = Schema;
