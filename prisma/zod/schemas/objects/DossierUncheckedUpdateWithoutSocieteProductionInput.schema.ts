...
import { PieceDossierUncheckedUpdateManyWithoutDossierNestedInputObjectSchema } from './PieceDossierUncheckedUpdateManyWithoutDossierNestedInput.schema';
import { CommentaireUncheckedUpdateManyWithoutDossierNestedInputObjectSchema } from './CommentaireUncheckedUpdateManyWithoutDossierNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.DossierUncheckedUpdateWithoutSocieteProductionInput> =
  z
    .object({
      id: z
        .union([
      ...
      piecesDossier: z
        .lazy(
          () =>
            PieceDossierUncheckedUpdateManyWithoutDossierNestedInputObjectSchema,
        )
        .optional(),
      commentaires: z
        .lazy(
          () =>
            CommentaireUncheckedUpdateManyWithoutDossierNestedInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const DossierUncheckedUpdateWithoutSocieteProductionInputObjectSchema =
  Schema;
