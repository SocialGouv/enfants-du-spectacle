...
import { NestedEnumStatutDossierWithAggregatesFilterObjectSchema } from './NestedEnumStatutDossierWithAggregatesFilter.schema';
import { NestedIntFilterObjectSchema } from './NestedIntFilter.schema';
import { NestedEnumStatutDossierFilterObjectSchema } from './NestedEnumStatutDossierFilter.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.EnumStatutDossierWithAggregatesFilter> = z
  .object({
...
export const EnumStatutDossierWithAggregatesFilterObjectSchema = Schema;
