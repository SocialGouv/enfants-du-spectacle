...
const Schema: z.ZodType<Prisma.DossierUncheckedUpdateWithoutCommissionInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const DossierUncheckedUpdateWithoutCommissionInputObjectSchema = Schema;
