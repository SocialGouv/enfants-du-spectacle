...
const Schema: z.ZodType<Prisma.DossierUncheckedCreateWithoutSocieteProductionInput> =
  z
    .object({
...
export const DossierUncheckedCreateWithoutSocieteProductionInputObjectSchema =
  Schema;
