...
const Schema: z.ZodType<Prisma.EnfantUncheckedUpdateManyWithoutEnfantsInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const EnfantUncheckedUpdateManyWithoutEnfantsInputObjectSchema = Schema;
