...
const Schema: z.ZodType<Prisma.DossierUpdateManyWithoutMedecinNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => DossierUpdateManyWithWhereWithoutMedecinInputObjectSchema),
        z
          .lazy(() => DossierUpdateManyWithWhereWithoutMedecinInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const DossierUpdateManyWithoutMedecinNestedInputObjectSchema = Schema;
