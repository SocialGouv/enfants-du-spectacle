...
const Schema: z.ZodType<Prisma.DossierUncheckedCreateWithoutCommissionInput> = z
  .object({
...
export const DossierUncheckedCreateWithoutCommissionInputObjectSchema = Schema;
