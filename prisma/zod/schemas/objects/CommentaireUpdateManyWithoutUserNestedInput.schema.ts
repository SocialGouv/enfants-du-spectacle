...
const Schema: z.ZodType<Prisma.CommentaireUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const CommentaireUpdateManyWithoutUserNestedInputObjectSchema = Schema;
