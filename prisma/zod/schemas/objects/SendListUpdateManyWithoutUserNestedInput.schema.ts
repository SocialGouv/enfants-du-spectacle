...
const Schema: z.ZodType<Prisma.SendListUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => SendListUpsertWithWhereUniqueWithoutUserInputObjectSchema),
        z
          .lazy(() => SendListUpsertWithWhereUniqueWithoutUserInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => SendListUpdateWithWhereUniqueWithoutUserInputObjectSchema),
        z
          .lazy(() => SendListUpdateWithWhereUniqueWithoutUserInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const SendListUpdateManyWithoutUserNestedInputObjectSchema = Schema;
