...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutCommentairesInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const UserUncheckedUpdateWithoutCommentairesInputObjectSchema = Schema;
