...
const Schema: z.ZodType<Prisma.DossierUpdateManyWithoutCommissionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DossierUpdateManyWithoutCommissionNestedInputObjectSchema = Schema;
