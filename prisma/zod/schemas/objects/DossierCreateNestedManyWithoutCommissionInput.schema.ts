...
const Schema: z.ZodType<Prisma.DossierCreateNestedManyWithoutCommissionInput> =
  z
    .object({
      create: z
        .union([
...
export const DossierCreateNestedManyWithoutCommissionInputObjectSchema = Schema;
