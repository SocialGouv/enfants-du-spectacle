...
const Schema: z.ZodType<Prisma.NestedEnumSTATUT_PIECENullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const NestedEnumSTATUT_PIECENullableWithAggregatesFilterObjectSchema =
  Schema;
