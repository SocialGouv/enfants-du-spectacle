...
const Schema: z.ZodType<Prisma.DossierUncheckedCreateNestedManyWithoutDemandeurInput> =
  z
    .object({
      create: z
        .union([
...
export const DossierUncheckedCreateNestedManyWithoutDemandeurInputObjectSchema =
  Schema;
