...
const Schema: z.ZodType<Prisma.SocieteProductionCreateWithoutDossiersInput> = z
  .object({
    nom: z.string(),
    siret: z.string(),
    siren: z.string(),
...
export const SocieteProductionCreateWithoutDossiersInputObjectSchema = Schema;
