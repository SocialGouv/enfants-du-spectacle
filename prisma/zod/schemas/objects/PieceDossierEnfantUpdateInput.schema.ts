...
import { EnfantUpdateOneWithoutPiecesDossierNestedInputObjectSchema } from './EnfantUpdateOneWithoutPiecesDossierNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.PieceDossierEnfantUpdateInput> = z
  .object({
    dossierId: z
      .union([
        z.number(),
    ...
    statut: z
      ...
      .nullable(),
    enfant: z
      .lazy(() => EnfantUpdateOneWithoutPiecesDossierNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const PieceDossierEnfantUpdateInputObjectSchema = Schema;
