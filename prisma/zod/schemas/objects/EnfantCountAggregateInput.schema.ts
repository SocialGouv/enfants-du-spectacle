...
const Schema: z.ZodType<Prisma.EnfantCountAggregateInputType> = z
  .object({
    ...
    justificatifs: z.literal(true).optional(),
    ...
    typeConsultationMedecin: z.literal(true).optional(),
...
export const EnfantCountAggregateInputObjectSchema = Schema;
