...
const Schema: z.ZodType<Prisma.PieceDossierEnfantUncheckedUpdateManyWithoutEnfantNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PieceDossierEnfantUncheckedUpdateManyWithoutEnfantNestedInputObjectSchema =
  Schema;
