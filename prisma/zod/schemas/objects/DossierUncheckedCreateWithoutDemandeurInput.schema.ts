...
const Schema: z.ZodType<Prisma.DossierUncheckedCreateWithoutDemandeurInput> = z
  .object({
...
export const DossierUncheckedCreateWithoutDemandeurInputObjectSchema = Schema;
