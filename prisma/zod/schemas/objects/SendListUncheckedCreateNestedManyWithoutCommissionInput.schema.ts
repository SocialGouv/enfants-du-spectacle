...
const Schema: z.ZodType<Prisma.SendListUncheckedCreateNestedManyWithoutCommissionInput> =
  z
    .object({
      create: z
        .union([
...
export const SendListUncheckedCreateNestedManyWithoutCommissionInputObjectSchema =
  Schema;
