...
const Schema: z.ZodType<Prisma.DossierUncheckedUpdateWithoutDemandeurInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const DossierUncheckedUpdateWithoutDemandeurInputObjectSchema = Schema;
