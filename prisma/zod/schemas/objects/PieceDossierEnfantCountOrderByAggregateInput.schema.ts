...
const Schema: z.ZodType<Prisma.PieceDossierEnfantCountOrderByAggregateInput> = z
  .object({
...
export const PieceDossierEnfantCountOrderByAggregateInputObjectSchema = Schema;
