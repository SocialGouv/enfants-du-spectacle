...
const Schema: z.ZodType<Prisma.EnfantUncheckedCreateNestedManyWithoutDossierInput> =
  z
    .object({
      create: z
        .union([
...
export const EnfantUncheckedCreateNestedManyWithoutDossierInputObjectSchema =
  Schema;
