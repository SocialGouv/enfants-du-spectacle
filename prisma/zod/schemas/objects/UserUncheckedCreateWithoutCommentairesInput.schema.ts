...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutCommentairesInput> = z
  .object({
...
export const UserUncheckedCreateWithoutCommentairesInputObjectSchema = Schema;
