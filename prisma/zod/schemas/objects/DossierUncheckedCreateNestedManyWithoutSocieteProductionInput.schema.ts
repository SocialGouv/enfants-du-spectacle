...
const Schema: z.ZodType<Prisma.DossierUncheckedCreateNestedManyWithoutSocieteProductionInput> =
  z
    .object({
      create: z
        .union([
...
export const DossierUncheckedCreateNestedManyWithoutSocieteProductionInputObjectSchema =
  Schema;
