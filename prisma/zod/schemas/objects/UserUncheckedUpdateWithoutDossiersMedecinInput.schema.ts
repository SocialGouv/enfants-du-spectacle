...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutDossiersMedecinInput> =
  z
    .object({
      id: z
        .union([
      ...
      dossiers: z
        .lazy(
          () => DossierUncheckedUpdateManyWithoutUserNestedInputObjectSchema,
        )
        .optional(),
      commentaires: z
        .lazy(
      ...
      SendList: z
        .lazy(
          () => SendListUncheckedUpdateManyWithoutUserNestedInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const UserUncheckedUpdateWithoutDossiersMedecinInputObjectSchema =
  Schema;
