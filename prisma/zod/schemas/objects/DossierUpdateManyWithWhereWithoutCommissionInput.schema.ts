...
const Schema: z.ZodType<Prisma.DossierUpdateManyWithWhereWithoutCommissionInput> =
  z
    .object({
...
export const DossierUpdateManyWithWhereWithoutCommissionInputObjectSchema =
  Schema;
