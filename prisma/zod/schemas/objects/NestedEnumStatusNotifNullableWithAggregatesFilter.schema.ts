...
const Schema: z.ZodType<Prisma.NestedEnumStatusNotifNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const NestedEnumStatusNotifNullableWithAggregatesFilterObjectSchema =
  Schema;
