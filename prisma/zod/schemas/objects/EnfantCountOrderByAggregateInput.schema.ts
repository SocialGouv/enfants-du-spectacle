...
const Schema: z.ZodType<Prisma.EnfantCountOrderByAggregateInput> = z
  .object({
    ...
    typeConsultationMedecin: z.lazy(() => SortOrderSchema).optional(),
...
export const EnfantCountOrderByAggregateInputObjectSchema = Schema;
