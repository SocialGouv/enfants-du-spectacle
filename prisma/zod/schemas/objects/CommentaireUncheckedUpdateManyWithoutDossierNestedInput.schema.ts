...
const Schema: z.ZodType<Prisma.CommentaireUncheckedUpdateManyWithoutDossierNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CommentaireUncheckedUpdateManyWithoutDossierNestedInputObjectSchema =
  Schema;
