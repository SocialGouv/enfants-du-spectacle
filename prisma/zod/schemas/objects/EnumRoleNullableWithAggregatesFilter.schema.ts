...
import { NestedEnumRoleNullableWithAggregatesFilterObjectSchema } from './NestedEnumRoleNullableWithAggregatesFilter.schema';
import { NestedIntNullableFilterObjectSchema } from './NestedIntNullableFilter.schema';
import { NestedEnumRoleNullableFilterObjectSchema } from './NestedEnumRoleNullableFilter.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.EnumRoleNullableWithAggregatesFilter> = z
  .object({
    equals: z
      .lazy(() => RoleSchema)
      .optional()
...
export const EnumRoleNullableWithAggregatesFilterObjectSchema = Schema;
