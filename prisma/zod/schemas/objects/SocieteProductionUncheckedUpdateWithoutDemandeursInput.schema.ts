...
const Schema: z.ZodType<Prisma.SocieteProductionUncheckedUpdateWithoutDemandeursInput> =
  z
    .object({
      id: z
        .union([
...
export const SocieteProductionUncheckedUpdateWithoutDemandeursInputObjectSchema =
  Schema;
