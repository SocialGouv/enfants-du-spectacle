...
const Schema: z.ZodType<Prisma.DossierCountAggregateInputType> = z
  .object({
    ...
    scenesSensibles: z.literal(true).optional(),
...
export const DossierCountAggregateInputObjectSchema = Schema;
