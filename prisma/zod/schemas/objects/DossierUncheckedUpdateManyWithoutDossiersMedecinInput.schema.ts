...
const Schema: z.ZodType<Prisma.DossierUncheckedUpdateManyWithoutDossiersMedecinInput> =
  z
    .object({
      id: z
        .union([
...
export const DossierUncheckedUpdateManyWithoutDossiersMedecinInputObjectSchema =
  Schema;
