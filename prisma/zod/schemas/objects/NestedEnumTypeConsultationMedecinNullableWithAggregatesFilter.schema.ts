...
const Schema: z.ZodType<Prisma.NestedEnumTypeConsultationMedecinNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const NestedEnumTypeConsultationMedecinNullableWithAggregatesFilterObjectSchema =
  Schema;
