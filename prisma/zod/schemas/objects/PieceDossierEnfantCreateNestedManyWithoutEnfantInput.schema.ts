...
const Schema: z.ZodType<Prisma.PieceDossierEnfantCreateNestedManyWithoutEnfantInput> =
  z
    .object({
      create: z
        .union([
...
export const PieceDossierEnfantCreateNestedManyWithoutEnfantInputObjectSchema =
  Schema;
