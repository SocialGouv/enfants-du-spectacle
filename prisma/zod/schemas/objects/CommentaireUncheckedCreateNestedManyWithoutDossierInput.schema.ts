...
const Schema: z.ZodType<Prisma.CommentaireUncheckedCreateNestedManyWithoutDossierInput> =
  z
    .object({
      create: z
        .union([
...
export const CommentaireUncheckedCreateNestedManyWithoutDossierInputObjectSchema =
  Schema;
