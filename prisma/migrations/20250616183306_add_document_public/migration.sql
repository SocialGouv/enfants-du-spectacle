-- CreateEnum
CREATE TYPE "CategorieDocument" AS ENUM ('CALENDRIER_COMMISSION_92', 'CALENDRIER_COMMISSION_HORS_92', 'MODELE_AUTORISATION', 'MODELE_DASEN', 'GUIDE_ENFANT_SPECTACLE', 'CIRCULAIRE');
