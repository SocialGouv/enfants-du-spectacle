-- CreateEnum
CREATE TYPE "AccessType" AS ENUM ('DOSSIER_LIST', 'DOSSIER_VIEW', 'PIECE_DOWNLOAD', 'PIECE_ENFANT_DOWNLOAD', 'COMMISSION_LIST', 'DOSSIER_UPDATE', 'ENFANT_UPDATE', 'PIECE_DOSSIEr_UPDATE', 'PIECE_ENFANT_UPDATE');
