      ...
      <div className={styles.container}>
        <div className={styles.contentWrapper}>
          ...
          <section>
            ...
            <ul>
              <li>
                Pour les enfants : nom et prénom, âge, certificat médical
                (critère discriminant permettant la réalisation du service),
                leur adresse complète, livret de famille, certificat de
                scolarité, et avis pédagogique en cas d’absence, autorisation
                écrite des enfants entre 13 ans et 16 ans, avis médical
                d’aptitude du médecin du travail, numéro de sécurité sociale
              </li>
              <li>
                Pour les représentants légaux : noms et prénoms, leur adresse
                complète (identique à celle de l’enfant), autorisation écrite
                accompagnée de la liste des emplois précédemment ou actuellement
                occupée, note de situation particulière par rapport à l’autorité
                parentale (ex : document relatif à une tutelle)
              </li>
              <li>
                Pour les personnes en charge du dépôt de dossier : prénom et
                nom, fonction, adresse e-mail, téléphone
              </li>
              <li>
                Pour le dossier : contrat de travail, rôle, personnage, jours
                travaillés, temps et lieu de travail, période de travail, et
          ...
          <section>
            ...
            <p>
              Enfants du spectacle manipule des données personnelles en se
              basant sur :
            </p>
            <ul>
              <li>
            ...
            <p>
              La mission d’intérêt public est fondée sur les articles R. 7124-1
              et suivants du Code du travail, en particulier les articles
              R.7124-3 et 7124-5 du code du travail.
            </p>
            <p>
              Le numéro de sécurité sociale est traité sur le fondement de
              l’article 30 de la loi n°78-17 du 6 janvier 1978 modifiée.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>
              ...
              en cas de doute, nous pourrons être amenés à vous demander la
            ...
            <p>
              Nous nous engageons à vous répondre dans un délai raisonnable qui
          ...
          <section>
            ...
            <p>
              ...
              autorisées, c’est-à-dire :
            </p>
            <ul>
              <li>les agents habilités de la DRIEETS</li>
              <li>les membres de la commission</li>
              <li>
                les médecins et assistantes médicales habilités de la société
                Thalie
              </li>
            </ul>
          </section>
          <section>
            ...
            <ul>
              ...
              <li>
                Stockage des mots de passe en base avec fonctionnalité de
                hachage
              </li>
          ...
          <section>
            ...
            <p>
              ...
              manipuler. Nous nous assurons qu’ils respectent strictement le
              RGPD et qu’ils apportent des garanties suffisantes en matière de
              sécurité.
            </p>
            <table>
              <thead>
              ...
              <tbody>
                <tr>
                  ...
                  <td>France</td>
                  <td>
                    <a href="https://doc.demarches-simplifiees.fr/mentions-legales">
          ...
          <section>
            ...
            <p>
              ...
              d’audience anonymisée. Conformément aux dispositions de l’article
              5 de la délibération CNIL numéro 2020-091 du 17 septembre 2020,
              l’usage de ces cookies de mesure d’audience est dispensé du
          ...
          <section>
            ...
            <p>
              ...
              Ces cookies sont limités à la mesure d’audience et n’effectuent
              pas de suivi global de l’utilisateur. L’objectif de cette mesure
