...
const InputComments: React.FC<Props> = ({ title, dossierId, enfantId, parentId }) => {
    ...
    <div className={styles.InputComments}>
        ...
        <ButtonLink onClick={() => {
            ...
            if(comment.length > 2) {
                ...
                contextDossier.processEntity('comments', [...contextDossier.comments, commentSent])
                setComment('')
            }
        }}>Ajouter un nouveau commentaire</ButtonLink>
