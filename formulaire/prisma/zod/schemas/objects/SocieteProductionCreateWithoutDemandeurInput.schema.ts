...
const Schema: z.ZodType<Prisma.SocieteProductionCreateWithoutDemandeurInput> = z
  .object({
...
export const SocieteProductionCreateWithoutDemandeurInputObjectSchema = Schema;
