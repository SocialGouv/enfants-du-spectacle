...
const Schema: z.ZodType<Prisma.CommentsUpdateManyWithoutEnfantNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => CommentsUpdateManyWithWhereWithoutEnfantInputObjectSchema),
        z
          .lazy(() => CommentsUpdateManyWithWhereWithoutEnfantInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const CommentsUpdateManyWithoutEnfantNestedInputObjectSchema = Schema;
