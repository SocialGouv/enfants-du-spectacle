...
const Schema: z.ZodType<Prisma.CommentsUpdateManyWithWhereWithoutEnfantInput> =
  z
    .object({
...
export const CommentsUpdateManyWithWhereWithoutEnfantInputObjectSchema = Schema;
