...
import { RemunerationUncheckedCreateNestedManyWithoutEnfantInputObjectSchema } from './RemunerationUncheckedCreateNestedManyWithoutEnfantInput.schema';
...
const Schema: z.ZodType<Prisma.EnfantUncheckedCreateWithoutPopulatedByInput> = z
  .object({
    ...
    remuneration: z
      .lazy(
        () =>
          RemunerationUncheckedCreateNestedManyWithoutEnfantInputObjectSchema,
      )
      .optional(),
    piecesDossier: z
      .lazy(
...
export const EnfantUncheckedCreateWithoutPopulatedByInputObjectSchema = Schema;
