...
import { EnfantUncheckedUpdateManyWithoutPopulatedByNestedInputObjectSchema } from './EnfantUncheckedUpdateManyWithoutPopulatedByNestedInput.schema';
...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutDossiersInput> = z
  .object({
    id: z
      .union([
        z.number(),
    ...
    Enfant: z
      .lazy(
        () =>
          EnfantUncheckedUpdateManyWithoutPopulatedByNestedInputObjectSchema,
      )
      .optional(),
    comments: z
...
export const UserUncheckedUpdateWithoutDossiersInputObjectSchema = Schema;
