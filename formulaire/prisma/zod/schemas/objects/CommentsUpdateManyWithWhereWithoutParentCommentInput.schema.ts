...
const Schema: z.ZodType<Prisma.CommentsUpdateManyWithWhereWithoutParentCommentInput> =
  z
    .object({
...
export const CommentsUpdateManyWithWhereWithoutParentCommentInputObjectSchema =
  Schema;
