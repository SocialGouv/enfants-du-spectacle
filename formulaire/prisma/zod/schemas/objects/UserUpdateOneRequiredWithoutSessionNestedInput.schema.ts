...
const Schema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutSessionNestedInput> =
  z
    .object({
      create: z
        .union([
        ...
        .optional(),
      connectOrCreate: z
        .lazy(() => UserCreateOrConnectWithoutSessionInputObjectSchema)
        .optional(),
      upsert: z
        .lazy(() => UserUpsertWithoutSessionInputObjectSchema)
        .optional(),
...
export const UserUpdateOneRequiredWithoutSessionNestedInputObjectSchema =
  Schema;
