...
const Schema: z.ZodType<Prisma.DemandeurUpdateOneWithoutDossiersNestedInput> = z
  .object({
    create: z
      .union([
...
export const DemandeurUpdateOneWithoutDossiersNestedInputObjectSchema = Schema;
