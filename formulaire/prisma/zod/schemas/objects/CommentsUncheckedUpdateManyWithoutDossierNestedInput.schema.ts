...
const Schema: z.ZodType<Prisma.CommentsUncheckedUpdateManyWithoutDossierNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CommentsUncheckedUpdateManyWithoutDossierNestedInputObjectSchema =
  Schema;
