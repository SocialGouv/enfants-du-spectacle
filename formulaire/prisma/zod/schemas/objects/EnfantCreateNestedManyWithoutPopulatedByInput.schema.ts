...
const Schema: z.ZodType<Prisma.EnfantCreateNestedManyWithoutPopulatedByInput> =
  z
    .object({
      create: z
        .union([
...
export const EnfantCreateNestedManyWithoutPopulatedByInputObjectSchema = Schema;
