...
import { PieceDossierUpdateManyWithoutDossierNestedInputObjectSchema } from './PieceDossierUpdateManyWithoutDossierNestedInput.schema';
import { UserUpdateOneRequiredWithoutDossiersNestedInputObjectSchema } from './UserUpdateOneRequiredWithoutDossiersNestedInput.schema';
import { DemandeurUpdateOneWithoutDossiersNestedInputObjectSchema } from './DemandeurUpdateOneWithoutDossiersNestedInput.schema';
import { CommentsUpdateManyWithoutDossierNestedInputObjectSchema } from './CommentsUpdateManyWithoutDossierNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.DossierUpdateWithoutEnfantsInput> = z
  .object({
    nom: z
      .union([
        z.string(),
    ...
    commissionString: z
      ...
      .nullable(),
    piecesDossier: z
      .lazy(() => PieceDossierUpdateManyWithoutDossierNestedInputObjectSchema)
      .optional(),
    user: z
      .lazy(() => UserUpdateOneRequiredWithoutDossiersNestedInputObjectSchema)
      .optional(),
    Demandeur: z
      .lazy(() => DemandeurUpdateOneWithoutDossiersNestedInputObjectSchema)
      .optional(),
    Comments: z
      .lazy(() => CommentsUpdateManyWithoutDossierNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const DossierUpdateWithoutEnfantsInputObjectSchema = Schema;
