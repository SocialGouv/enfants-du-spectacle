...
const Schema: z.ZodType<Prisma.DossierUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const DossierUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
