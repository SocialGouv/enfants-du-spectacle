...
import { DossierCreateNestedOneWithoutEnfantsInputObjectSchema } from './DossierCreateNestedOneWithoutEnfantsInput.schema';
...
const Schema: z.ZodType<Prisma.EnfantCreateWithoutPiecesDossierInput> = z
  .object({
    ...
    remuneration: z
      ...
      .optional(),
    dossier: z
      .lazy(() => DossierCreateNestedOneWithoutEnfantsInputObjectSchema)
      .optional(),
    populatedBy: z
...
export const EnfantCreateWithoutPiecesDossierInputObjectSchema = Schema;
