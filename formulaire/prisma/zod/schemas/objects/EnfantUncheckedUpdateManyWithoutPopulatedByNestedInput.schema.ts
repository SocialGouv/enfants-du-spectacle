...
const Schema: z.ZodType<Prisma.EnfantUncheckedUpdateManyWithoutPopulatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EnfantUncheckedUpdateManyWithoutPopulatedByNestedInputObjectSchema =
  Schema;
