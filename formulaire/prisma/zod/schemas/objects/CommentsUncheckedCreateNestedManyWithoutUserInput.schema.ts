...
const Schema: z.ZodType<Prisma.CommentsUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const CommentsUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
