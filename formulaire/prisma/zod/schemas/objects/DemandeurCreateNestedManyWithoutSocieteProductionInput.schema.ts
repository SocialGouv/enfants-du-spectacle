...
const Schema: z.ZodType<Prisma.DemandeurCreateNestedManyWithoutSocieteProductionInput> =
  z
    .object({
      create: z
        .union([
...
export const DemandeurCreateNestedManyWithoutSocieteProductionInputObjectSchema =
  Schema;
