...
const Schema: z.ZodType<Prisma.NestedEnumSourcecommentWithAggregatesFilter> = z
  .object({
...
export const NestedEnumSourcecommentWithAggregatesFilterObjectSchema = Schema;
