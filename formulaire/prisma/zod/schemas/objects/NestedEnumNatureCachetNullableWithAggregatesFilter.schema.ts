...
const Schema: z.ZodType<Prisma.NestedEnumNatureCachetNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const NestedEnumNatureCachetNullableWithAggregatesFilterObjectSchema =
  Schema;
