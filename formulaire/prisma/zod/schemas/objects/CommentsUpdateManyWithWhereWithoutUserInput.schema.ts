...
const Schema: z.ZodType<Prisma.CommentsUpdateManyWithWhereWithoutUserInput> = z
  .object({
    where: z.lazy(() => CommentsScalarWhereInputObjectSchema),
    data: z.union([
      z.lazy(() => CommentsUpdateManyMutationInputObjectSchema),
      z.lazy(() => CommentsUncheckedUpdateManyWithoutCommentsInputObjectSchema),
    ]),
  })
  .strict();

export const CommentsUpdateManyWithWhereWithoutUserInputObjectSchema = Schema;
