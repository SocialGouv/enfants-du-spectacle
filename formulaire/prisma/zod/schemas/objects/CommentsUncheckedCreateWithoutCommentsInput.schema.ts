...
const Schema: z.ZodType<Prisma.CommentsUncheckedCreateWithoutCommentsInput> = z
  .object({
...
export const CommentsUncheckedCreateWithoutCommentsInputObjectSchema = Schema;
