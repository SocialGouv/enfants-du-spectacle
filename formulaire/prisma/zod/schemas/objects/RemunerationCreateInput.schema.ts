...
import { EnfantCreateNestedOneWithoutRemunerationInputObjectSchema } from './EnfantCreateNestedOneWithoutRemunerationInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.RemunerationCreateInput> = z
  .object({
    ...
    Enfant: z
      .lazy(() => EnfantCreateNestedOneWithoutRemunerationInputObjectSchema)
      .optional(),
  })
  .strict();

export const RemunerationCreateInputObjectSchema = Schema;
