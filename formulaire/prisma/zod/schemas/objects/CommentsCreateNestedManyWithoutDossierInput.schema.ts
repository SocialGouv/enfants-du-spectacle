...
const Schema: z.ZodType<Prisma.CommentsCreateNestedManyWithoutDossierInput> = z
  .object({
    create: z
      .union([
...
export const CommentsCreateNestedManyWithoutDossierInputObjectSchema = Schema;
