...
const Schema: z.ZodType<Prisma.PieceDossierEnfantUncheckedUpdateWithoutEnfantInput> =
  z
    .object({
      id: z
        .union([
...
export const PieceDossierEnfantUncheckedUpdateWithoutEnfantInputObjectSchema =
  Schema;
