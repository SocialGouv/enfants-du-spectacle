...
const Schema: z.ZodType<Prisma.CommentsUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => CommentsUpsertWithWhereUniqueWithoutUserInputObjectSchema),
        z
          .lazy(() => CommentsUpsertWithWhereUniqueWithoutUserInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => CommentsUpdateWithWhereUniqueWithoutUserInputObjectSchema),
        z
          .lazy(() => CommentsUpdateWithWhereUniqueWithoutUserInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const CommentsUpdateManyWithoutUserNestedInputObjectSchema = Schema;
