...
const Schema: z.ZodType<Prisma.PieceDossierEnfantUncheckedUpdateManyWithoutPiecesDossierInput> =
  z
    .object({
      id: z
        .union([
...
export const PieceDossierEnfantUncheckedUpdateManyWithoutPiecesDossierInputObjectSchema =
  Schema;
