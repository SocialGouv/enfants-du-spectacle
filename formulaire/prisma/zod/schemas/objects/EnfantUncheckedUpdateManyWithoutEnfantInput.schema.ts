...
const Schema: z.ZodType<Prisma.EnfantUncheckedUpdateManyWithoutEnfantInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const EnfantUncheckedUpdateManyWithoutEnfantInputObjectSchema = Schema;
