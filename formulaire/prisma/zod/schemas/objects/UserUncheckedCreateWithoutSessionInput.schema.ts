...
import { EnfantUncheckedCreateNestedManyWithoutPopulatedByInputObjectSchema } from './EnfantUncheckedCreateNestedManyWithoutPopulatedByInput.schema';
...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutSessionInput> = z
  .object({
    ...
    Enfant: z
      .lazy(
        () =>
          EnfantUncheckedCreateNestedManyWithoutPopulatedByInputObjectSchema,
      )
      .optional(),
    comments: z
...
export const UserUncheckedCreateWithoutSessionInputObjectSchema = Schema;
