...
import { EnfantCreateNestedManyWithoutPopulatedByInputObjectSchema } from './EnfantCreateNestedManyWithoutPopulatedByInput.schema';
import { CommentsCreateNestedManyWithoutUserInputObjectSchema } from './CommentsCreateNestedManyWithoutUserInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.UserCreateWithoutDossiersInput> = z
  .object({
    ...
    Session: z
      ...
      .optional(),
    Enfant: z
      .lazy(() => EnfantCreateNestedManyWithoutPopulatedByInputObjectSchema)
      .optional(),
    comments: z
...
export const UserCreateWithoutDossiersInputObjectSchema = Schema;
