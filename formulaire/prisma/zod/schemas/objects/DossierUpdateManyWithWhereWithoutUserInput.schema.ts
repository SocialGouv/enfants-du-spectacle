...
const Schema: z.ZodType<Prisma.DossierUpdateManyWithWhereWithoutUserInput> = z
  .object({
    where: z.lazy(() => DossierScalarWhereInputObjectSchema),
    data: z.union([
      z.lazy(() => DossierUpdateManyMutationInputObjectSchema),
      z.lazy(() => DossierUncheckedUpdateManyWithoutDossiersInputObjectSchema),
    ]),
  })
  .strict();

export const DossierUpdateManyWithWhereWithoutUserInputObjectSchema = Schema;
