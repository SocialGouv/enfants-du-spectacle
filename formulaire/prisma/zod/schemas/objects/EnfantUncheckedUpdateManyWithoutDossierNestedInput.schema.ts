...
const Schema: z.ZodType<Prisma.EnfantUncheckedUpdateManyWithoutDossierNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => EnfantUpdateManyWithWhereWithoutDossierInputObjectSchema,
          ),
          z
            .lazy(
              () => EnfantUpdateManyWithWhereWithoutDossierInputObjectSchema,
...
export const EnfantUncheckedUpdateManyWithoutDossierNestedInputObjectSchema =
  Schema;
