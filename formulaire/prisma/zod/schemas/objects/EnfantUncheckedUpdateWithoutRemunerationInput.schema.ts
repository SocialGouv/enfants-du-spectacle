...
const Schema: z.ZodType<Prisma.EnfantUncheckedUpdateWithoutRemunerationInput> =
  z
    .object({
      id: z
        .union([
...
export const EnfantUncheckedUpdateWithoutRemunerationInputObjectSchema = Schema;
