...
const Schema: z.ZodType<Prisma.DossierUpdateManyWithoutDemandeurNestedInput> = z
  .object({
    create: z
      .union([
...
export const DossierUpdateManyWithoutDemandeurNestedInputObjectSchema = Schema;
