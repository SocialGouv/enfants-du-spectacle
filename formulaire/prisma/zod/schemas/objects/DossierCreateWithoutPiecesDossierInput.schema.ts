...
import { EnfantCreateNestedManyWithoutDossierInputObjectSchema } from './EnfantCreateNestedManyWithoutDossierInput.schema';
...
import { CommentsCreateNestedManyWithoutDossierInputObjectSchema } from './CommentsCreateNestedManyWithoutDossierInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.DossierCreateWithoutPiecesDossierInput> = z
  .object({
    ...
    enfants: z
      .lazy(() => EnfantCreateNestedManyWithoutDossierInputObjectSchema)
      .optional(),
    user: z.lazy(() => UserCreateNestedOneWithoutDossiersInputObjectSchema),
    Demandeur: z
      .lazy(() => DemandeurCreateNestedOneWithoutDossiersInputObjectSchema)
      .optional(),
    Comments: z
      .lazy(() => CommentsCreateNestedManyWithoutDossierInputObjectSchema)
      .optional(),
  })
  .strict();

export const DossierCreateWithoutPiecesDossierInputObjectSchema = Schema;
