...
import { DossierUpdateOneWithoutEnfantsNestedInputObjectSchema } from './DossierUpdateOneWithoutEnfantsNestedInput.schema';
...
const Schema: z.ZodType<Prisma.EnfantUpdateWithoutRemunerationInput> = z
  .object({
    prenom: z
      .union([
        z.string(),
    ...
    piecesDossier: z
      ...
      .optional(),
    dossier: z
      .lazy(() => DossierUpdateOneWithoutEnfantsNestedInputObjectSchema)
      .optional(),
    populatedBy: z
...
export const EnfantUpdateWithoutRemunerationInputObjectSchema = Schema;
