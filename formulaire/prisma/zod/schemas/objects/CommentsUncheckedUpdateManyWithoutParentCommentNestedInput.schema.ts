...
const Schema: z.ZodType<Prisma.CommentsUncheckedUpdateManyWithoutParentCommentNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CommentsUncheckedUpdateManyWithoutParentCommentNestedInputObjectSchema =
  Schema;
