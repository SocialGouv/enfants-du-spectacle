...
import { DossierUpdateOneRequiredWithoutCommentsNestedInputObjectSchema } from './DossierUpdateOneRequiredWithoutCommentsNestedInput.schema';
...
const Schema: z.ZodType<Prisma.CommentsUpdateWithoutParentCommentInput> = z
  .object({
    text: z
      .union([
        z.string(),
    ...
    dossier: z
      .lazy(
        () => DossierUpdateOneRequiredWithoutCommentsNestedInputObjectSchema,
      )
      .optional(),
    enfant: z
...
export const CommentsUpdateWithoutParentCommentInputObjectSchema = Schema;
