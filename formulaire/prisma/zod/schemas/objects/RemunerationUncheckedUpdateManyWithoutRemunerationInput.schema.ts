...
const Schema: z.ZodType<Prisma.RemunerationUncheckedUpdateManyWithoutRemunerationInput> =
  z
    .object({
      id: z
        .union([
...
export const RemunerationUncheckedUpdateManyWithoutRemunerationInputObjectSchema =
  Schema;
