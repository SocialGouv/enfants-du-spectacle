...
const Schema: z.ZodType<Prisma.CommentsCreateNestedManyWithoutParentCommentInput> =
  z
    .object({
      create: z
        .union([
...
export const CommentsCreateNestedManyWithoutParentCommentInputObjectSchema =
  Schema;
