...
import { RemunerationUncheckedUpdateManyWithoutEnfantNestedInputObjectSchema } from './RemunerationUncheckedUpdateManyWithoutEnfantNestedInput.schema';
import { PieceDossierEnfantUncheckedUpdateManyWithoutEnfantNestedInputObjectSchema } from './PieceDossierEnfantUncheckedUpdateManyWithoutEnfantNestedInput.schema';
import { CommentsUncheckedUpdateManyWithoutEnfantNestedInputObjectSchema } from './CommentsUncheckedUpdateManyWithoutEnfantNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.EnfantUncheckedUpdateWithoutPopulatedByInput> = z
  .object({
    id: z
      .union([
        z.number(),
    ...
    remuneration: z
      .lazy(
        () =>
          RemunerationUncheckedUpdateManyWithoutEnfantNestedInputObjectSchema,
      )
      .optional(),
    piecesDossier: z
      .lazy(
        () =>
          PieceDossierEnfantUncheckedUpdateManyWithoutEnfantNestedInputObjectSchema,
      )
      .optional(),
    Comments: z
      .lazy(
        () => CommentsUncheckedUpdateManyWithoutEnfantNestedInputObjectSchema,
      )
      .optional(),
  })
  .strict();

export const EnfantUncheckedUpdateWithoutPopulatedByInputObjectSchema = Schema;
