...
const Schema: z.ZodType<Prisma.RemunerationUncheckedCreateNestedManyWithoutEnfantInput> =
  z
    .object({
      create: z
        .union([
...
export const RemunerationUncheckedCreateNestedManyWithoutEnfantInputObjectSchema =
  Schema;
