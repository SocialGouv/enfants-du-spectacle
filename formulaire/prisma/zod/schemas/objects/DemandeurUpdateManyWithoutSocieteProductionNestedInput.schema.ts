...
const Schema: z.ZodType<Prisma.DemandeurUpdateManyWithoutSocieteProductionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DemandeurUpdateManyWithoutSocieteProductionNestedInputObjectSchema =
  Schema;
