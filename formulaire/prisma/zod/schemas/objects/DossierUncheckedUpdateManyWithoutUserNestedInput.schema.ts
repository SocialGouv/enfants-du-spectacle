...
const Schema: z.ZodType<Prisma.DossierUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => DossierUpsertWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => DossierUpsertWithWhereUniqueWithoutUserInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => DossierUpdateWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => DossierUpdateWithWhereUniqueWithoutUserInputObjectSchema,
...
export const DossierUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
