...
import { NestedEnumTypeEmploiNullableWithAggregatesFilterObjectSchema } from './NestedEnumTypeEmploiNullableWithAggregatesFilter.schema';
...
const Schema: z.ZodType<Prisma.EnumTypeEmploiNullableWithAggregatesFilter> = z
  .object({
    equals: z
...
export const EnumTypeEmploiNullableWithAggregatesFilterObjectSchema = Schema;
